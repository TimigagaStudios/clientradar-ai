...
import { DollarSign, Handshake, TrendingUp, Search, CheckCircle2, XCircle, Clock3 } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
        <div className="neo-card p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="p-3 rounded-2xl neo-in"><Handshake size={20} className="text-[var(--accent)]" /></div>
          </div>
        ...
        <div className="neo-card p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="p-3 rounded-2xl neo-in"><Clock3 size={20} className="text-[var(--accent)]" /></div>
          </div>
        ...
        <div className="neo-card p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="p-3 rounded-2xl neo-in"><TrendingUp size={20} className="text-[var(--accent)]" /></div>
          </div>
        ...
        <div className="neo-card p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="p-3 rounded-2xl neo-in"><CheckCircle2 size={20} className="text-[var(--accent)]" /></div>
          </div>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 pt-4 border-t border-black/8 dark:border-white/8">
              <div>
                ...
                <p className="text-lg font-black text-[var(--text-primary)]">${Number(lead.dealValue || 0).toLocaleString()}</p>
              </div>
              <div>
