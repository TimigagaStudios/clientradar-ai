...
export default function LeadGlobe() {
  ...
  const focusLead = (lead: LeadPoint) => {
    ...
    globeRef.current?.pointOfView({ lat: lead.latitude, lng: lead.longitude, altitude: 0.62 }, 1100);
  };

  const resetView = () => {
    setSelectedId(null);
    globeRef.current?.pointOfView({ lat: 20, lng: 10, altitude: 2.35 }, 1100);
  };
